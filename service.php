...
echo " " . $all;
          ...
          <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
              <div class="mdl-cell--12-col">
                  <h3 class="mdl-color--teal-300" style="padding: 10px; color: white;">График на услугата:</h3>
                  <hr>
              </div>
              <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
                  <?php for($i=0;$i<1;$i++) { ?>
...
echo "Дата: " . $Date3; ?></h3>
              ...
              <?php
              $query_Eventss = "select count(*) as rows from servcontrol where servicename = '$keyche' and date = '$Date2' and time >= '$time2'";
...
if($all != 0){ ?>
  ...
  $query_Events = "select * from servcontrol where servicename = '$keyche' and date = '$Date2' and time >= '$time2' order by time asc";
$result = (mysqli_query($conn, $query_Events)) or die(mysqli_error($conn));
if(!$result){
echo mysqli_error();
} else{
