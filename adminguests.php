    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--teal-300 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a style="color: white;" class="mdl-navigation__link active" href="adminguests.php"><i style="color: white;" class="mdl-color-text--blue-grey-400 material-icons" role="presentation">people</i>Гости</a>
          <?php if($_SESSION['role'] == "admin") { ?>
...
echo " " . $all;
          ...
          <div class="demo-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col">
              <div class="mdl-cell--12-col">
                  <h3 class="mdl-color--teal-300" style="padding: 10px; color: white;">Списък с всички гости на хотела</h3>
                  <hr>
              </div>
...
$dedate = $row['ddate'];
    ...
    <tr>
        ...
        <td><?php echo $tel; ?></td>
        <td><a href="guest.php?room=<?php echo $roomn; ?>" style="color: black;"><?php echo $roomn; ?></a></td>
      ...
      <?php } } ?>
              ...
              <form action="adminguests.php" method="post">
...
if($all != 1){
    ...
    ?>
              <script>
    window.location.href = 'guest.php?room=<?php echo $room; ?>';
    </script>
              <?php
              } }
}
